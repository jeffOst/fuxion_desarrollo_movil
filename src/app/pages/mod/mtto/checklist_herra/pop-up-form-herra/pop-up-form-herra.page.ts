...
@Component({
  selector: 'app-pop-up-form-herra',
  templateUrl: './pop-up-form-herra.page.html',
  styleUrls: ['./pop-up-form-herra.page.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule]
})
export class PopUpFormHerraPage implements OnInit {
  ...
  FFindRows() {
    const loading = this.loadingController.create({
      ...
      loading => {
        loading.present();
        this.ApiService.LisHerramienta(this.NgModInputSearch).then((res) => {
