...
@Component({
  selector: 'app-mtto-win-informe-tecnico',
  templateUrl: './mtto-win-informe-tecnico.page.html',
  styleUrls: ['./mtto-win-informe-tecnico.page.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule]
})
export class MttoWinInformeTecnicoPage implements OnInit {
  ...
  tituloTollBar: string = 'Informe Tecnico';
  constructor(
