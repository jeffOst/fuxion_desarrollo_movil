...
@Component({
  selector: 'app-mtto-win-informe-tecnico4',
  templateUrl: './mtto-win-informe-tecnico4.page.html',
  styleUrls: ['./mtto-win-informe-tecnico4.page.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule]
})
export class MttoWinInformeTecnico4Page implements OnInit {
