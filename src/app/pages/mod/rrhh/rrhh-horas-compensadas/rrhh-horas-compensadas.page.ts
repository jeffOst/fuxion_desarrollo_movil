...
@Component({
  selector: 'app-rrhh-horas-compensadas',
  templateUrl: './rrhh-horas-compensadas.page.html',
  styleUrls: ['./rrhh-horas-compensadas.page.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule,ReactiveFormsModule]
})
export class RrhhHorasCompensadasPage implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log('this.navParamsAny',this.navParamsAny.id_areapert);
  ...
  cancelar_ejecucion() {
     this.navCtrl.navigateForward('rrhh-list-horas-compensadas');////addnoprogramado
  }
          ...
          buttons: [
            {
              ...
              handler: () => {
                ...
                if (res[0].o_nres == '1') {
                  this.navCtrl.navigateForward(['rrhh-list-horas-compensadas']);
                }
              },
            },
          ],
