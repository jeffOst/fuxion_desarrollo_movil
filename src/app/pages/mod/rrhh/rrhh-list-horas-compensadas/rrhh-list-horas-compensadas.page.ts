...
@Component({
  selector: 'app-rrhh-list-horas-compensadas',
  templateUrl: './rrhh-list-horas-compensadas.page.html',
  styleUrls: ['./rrhh-list-horas-compensadas.page.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule, HeaderComponent]
})
export class RrhhListHorasCompensadasPage implements OnInit {
...
if (this.searchTerm.trim().length >=6) {
  ...
  FSelectedItem(row: any) {
    ...
    this.navCtrl.navigateForward(['rrhh-horas-compensadas'], navigationExtras);
